...
('MODIFIER_BELIEF_FFXIV_2_GLOBAL_SCIENCE', 'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER', 0, 0, 0, NULL, NULL);
...
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('MODIFIER_BELIEF_FFXIV_2_GLOBAL_CULTURE', 'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER', 0, 0, 0, NULL, NULL);
...
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('MODIFIER_BELIEF_FFXIV_2_WIND_MOVEMENT', 'MODIFIER_PLAYER_CITIES_ADJUST_MILITARY_UNITS_PRODUCTION', 0, 0, 0, NULL, NULL);

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('MODIFIER_BELIEF_FFXIV_2_WIND_MOVEMENT', 'Amount', '30'), 
('MODIFIER_BELIEF_FFXIV_2_WIND_MOVEMENT', 'EndEra', 'ERA_FUTURE'), 
('MODIFIER_BELIEF_FFXIV_2_WIND_MOVEMENT', 'StartEra', 'ERA_ANCIENT');
...
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('MODIFIER_FFXIV_2_THUNDER_EXTRA_DISTRICT', 'MODIFIER_SINGLE_CITY_EXTRA_DISTRICT', 0, 0, 0, NULL, NULL);

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('MODIFIER_FFXIV_2_THUNDER_EXTRA_DISTRICT', 'Amount', '1');
