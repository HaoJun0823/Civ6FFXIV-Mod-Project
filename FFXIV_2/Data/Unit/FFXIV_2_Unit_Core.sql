...
('MODIFIER_FFXIV_2_UNIT_FOREST_MOVEMENT', 'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT', 0, 0, 0, NULL, 'REQSET_FFXIV_IN_OWNER_TERRITORY');
...
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('MODIFIER_FFXIV_2_UNIT_FOREST_COMBAT', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 0, 0, 0, NULL, 'REQSET_FFXIV_IN_OWNER_TERRITORY');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('MODIFIER_FFXIV_2_UNIT_FOREST_COMBAT', 'Amount', '5');
...
('REQ_FFXIV_IN_OWNER_TERRITORY', 'REQUIREMENT_UNIT_ON_HOME_CONTINENT');
